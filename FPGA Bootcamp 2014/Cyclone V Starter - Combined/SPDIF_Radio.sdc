...
create_clock           \
 ...
 -period   160ns       \
 -waveform {0ns 80ns}  \
 [get_registers *SPDIF_Decoder:SPDIF_Decoder1|Sound_Clk_Counter[4]]
...
set_false_path                                                               \
 -from [get_registers Receiver:Receiver1|Powerup_Timer:Powerup_Timer1|Reset] \
 -to   [get_registers Receiver:Receiver1|Graphics:Graphics1|VGA_Text:VGA|tReset]
...
set_false_path                                                        \
 -from [get_registers Receiver:Receiver1|Audio_Player:Audio_Player1*] \
 -to   [get_registers Receiver:Receiver1|Graphics:Graphics1*]
...
set_false_path -from [get_clocks    *] -to [get_ports GPIO*]
...
create_clock -name SD_Clk -period 22.140ns
