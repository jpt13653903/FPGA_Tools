...
set_false_path                                                               \
 -from [get_registers Powerup_Timer:Powerup_Timer1|Reset] \
 -to   [get_registers Graphics:Graphics1|VGA_Text:VGA|tReset]
...
set_false_path                                                        \
 -from [get_registers Audio_Player:Audio_Player1*] \
 -to   [get_registers Graphics:Graphics1*]
